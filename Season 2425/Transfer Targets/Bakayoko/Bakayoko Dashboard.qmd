...
#set oppo
Match_Oppo <- paste("PSV Eindhoven")
...
#Set LFC
Match_LFC <- paste("Dortmund")

#set Home color
Color_LFC <- paste("yellow2")

#set home text color
Color_LFC_Text <- paste("black")
...
ColorScale_HomeC <- paste("grDevices::Cividis")

#set away color scale con
ColorScale_AwayC <- paste("ggthemes::Red")

#set match date
Game_date <- paste("20-02-24")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/280841d0/PSV-Eindhoven-Dortmund-February-20-2024-Champions-League") #check

#set Game name
GameName <- paste("PSVFC_vs_BDFC_UCLR16L1")

GameWeek <- paste("UCLR16L1")

#set Game name PLayers
GameNamePlayers <- paste("PSVFC_vs_BDFC_UCLR16L1_players")
...
Transfer_Target <- paste("Johan Bakayoko")
...
Oppotouchpass_bar_plot <- Oppotouchpass_bar_data %>%
  ...
  labs(title = paste0(Transfer_Target, " - ",OppoWavesTitle_text),
...
Zone14_HS_Passes_LFC_Plot <- Z14_HS_Passes_LFC_Data %>%
  ...
  #facet_wrap(~ Game_Period, ncol = 4) +
  labs(title = paste0(Transfer_Target, " Zone 14 and HS ", OppoPPsTitle_text), 
       subtitle = paste0(Match_Fixture),
       caption = My_caption) +
  theme(plot.title = element_markdown(),
        plot.subtitle = element_text(colour = "black", size = 12),
...
# Calculate average player position
      OppoAverage_Player1Sub <- OppoEPVHeatMapData1sub %>% 
        group_by(playerId, player_shirt) %>% 
        summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
        na.omit() %>%
        mutate(x = (100 - x),
...
# Calculate average player position
      OppoAverage_PlayerP1Sub <- OppoEPVHeatMapDataP1sub %>% 
        group_by(playerId, player_shirt) %>% 
        summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
        na.omit() %>%
        mutate(x = (100 - x),
...
EPVHeatMapplot1sub <- EPVHeatMapData1sub %>%
  ...
  #plot player positions
  geom_point(data = OppoAverage_Player1Sub, aes(x, y), fill = Color_Oppo, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = OppoAverage_Player1Sub, aes(x, y, label = player_shirt), color = Color_Oppo_Text, size = 2) +
...
EPVHeatMapplotP1sub <- EPVHeatMapDataP1sub %>%
  ...
  #plot player positions
  geom_point(data = OppoAverage_PlayerP1Sub, aes(x, y), fill = Color_Oppo, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = OppoAverage_PlayerP1Sub, aes(x, y, label = player_shirt), color = Color_Oppo_Text, size = 2) +
...
OppoEPVHeatMapplot1sub <- OppoEPVHeatMapData1sub %>%
  ...
  #plot player positions
  geom_point(data = Average_Player1Sub, aes(x, y), fill = Color_LFC, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = Average_Player1Sub, aes(x, y, label = player_shirt), color = Color_LFC_Text, size = 2) +
...
OppoEPVHeatMapplotP1sub <- OppoEPVHeatMapDataP1sub %>%
  ...
  # add zone percentage numbers
  geom_text(data = Oppoaverage_epvNZP1sub, aes(x = x, y = y, label = paste(PEPV, "%")), size = 5) +
  
  #plot player positions
  geom_point(data = Average_PlayerP1Sub, aes(x, y), fill = Color_LFC, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = Average_PlayerP1Sub, aes(x, y, label = player_shirt), color = Color_LFC_Text, size = 2) +
...
# Calculate average player position
      OppoAverage_Player1H <- OppoEPVHeatMapData1H %>% 
        group_by(playerId, player_shirt) %>% 
        summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
        na.omit() %>%
        mutate(x = (100 - x),
...
# Calculate average player position
      OppoAverage_Player2H <- OppoEPVHeatMapData2H %>% 
        group_by(playerId, player_shirt) %>% 
        summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
        na.omit() %>%
        mutate(x = (100 - x),
...
EPVHeatMapplot1H <- EPVHeatMapData1H %>%
  ...
  #plot player positions
  geom_point(data = OppoAverage_Player1H, aes(x, y), fill = Color_Oppo, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = OppoAverage_Player1H, aes(x, y, label = player_shirt), color = Color_Oppo_Text, size = 2) +
...
EPVHeatMapplot2H <- EPVHeatMapData2H %>%
  ...
  #plot player positions
  geom_point(data = OppoAverage_Player2H, aes(x, y), fill = Color_Oppo, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = OppoAverage_Player2H, aes(x, y, label = player_shirt), color = Color_Oppo_Text, size = 2) +
...
OppoEPVHeatMapplot1H <- OppoEPVHeatMapData1H %>%
  ...
  # add zone percentage numbers
  geom_text(data = Oppoaverage_epvNZ1H, aes(x = x, y = y, label = paste(PEPV, "%")), size = 5) +
  
  #plot player positions
  geom_point(data = Average_Player1H, aes(x, y), fill = Color_LFC, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = Average_Player1H, aes(x, y, label = player_shirt), color = Color_LFC_Text, size = 2) +
...
OppoEPVHeatMapplot2H <- OppoEPVHeatMapData2H %>%
  ...
  # add zone percentage numbers
  geom_text(data = Oppoaverage_epvNZ2H, aes(x = x, y = y, label = paste(PEPV, "%")), size = 5) +
  
  #plot player positions
  geom_point(data = Average_Player2H, aes(x, y), fill = Color_LFC, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = Average_Player2H, aes(x, y, label = player_shirt), color = Color_LFC_Text, size = 2) +
...
#  pivot_longer(cols = c(TotalxG, TotalNPxG, TotalxGOT), names_to = "Metric", values_to = "Value")
  ...
  labs(x = "Match Time (mins)", 
       y = "xG, NPxG, xGOT",
       title = paste0(Transfer_Target, " ", OppoxGlineTitle_text),
       caption = My_caption,
       subtitle = paste0(Match_Fixture))  +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        panel.background = element_rect(colour = "snow", fill = "snow"),
...
#|height: 110%
#shot map
LFC_S_plot <- plot_shot_AI(dashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = "", mapName = Transfer_Target, teamColor = Color_Oppo, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", logo = "", wrap = "")
...
#|height: 110%
LFC_S_plotW <- plot_shot_AI(dashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = "", mapName = Transfer_Target, teamColor = Color_Oppo, text_color = Color_Oppo_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", logo = "", wrap = "Player")
...
#|height: 110%
LFC_S_plotWT <- plot_shot_AI(dashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = "", mapName = Transfer_Target, teamColor = Color_Oppo, text_color = Color_Oppo_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", logo = "", wrap = "Time")
