...
MatchIdFbref <- paste("https://fbref.com/en/matches/25fd86bc/Monaco-Nantes-February-15-2025-Ligue-1") #check
...
#set transfer target
Transfer_Target <- paste("Lamine Camara")
