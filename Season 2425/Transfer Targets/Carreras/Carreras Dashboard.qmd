...
#set Away
Away_Team <- paste0("Bologna")

#set Away color
Color_Away <- paste("red2")

#set Away text
Color_Away_Text <- paste("black")

#Set Home
Home_Team <- paste0("Benfica")

#set Home color
Color_Home <- paste("red3")

#set home text color
Color_Home_Text <- paste("green4")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/539a620f/Benfica-Bologna-December-11-2024-Champions-League") #check
...
#set transfer target
Transfer_Target <- paste("Álvaro Carreras")
