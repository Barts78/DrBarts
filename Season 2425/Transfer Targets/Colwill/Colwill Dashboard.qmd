...
#set fixture
Match_Fixture <- paste0(Match_LFC, " vs ", Match_Oppo, " (n) ", Game_date)

#set dashboard fixture
Match_Fixture_Dash <- paste0(Match_LFC, " vs ", Match_Oppo, " (n) ", Game_date)

#Set Fotmob Match ID
MatchIdFotmob <- 4387928 #check
...
#set Game name
GameName <- paste("LFC_vs_CFC_CCF")

GameWeek <- paste("CCF")

#set Game name PLayers
GameNamePlayers <- paste("LFC_vs_CFC_CCF_players")
...
#load in data frames
#load in main data 
fileName <- paste0("~/Dropbox/AI lfc data/Data Sets/WhoScored/LC Games/", GameName, ".xlsx")
...
Transfer_Target <- paste("Levi Colwill")
