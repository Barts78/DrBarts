...
#set Away
Away_Team <- paste("Wolverhampton Wanderers")

#set Away color
Color_Away <- paste("#d99b00")

#set Away text
Color_Away_Text <- paste("black")

#Set LFC
Home_Team <- paste("Liverpool")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/438254ac/Stuttgart-Paris-Saint-Germain-January-29-2025-Champions-League") #check
...
#set transfer target
Transfer_Target <- paste("Matheus Cunha")
```
