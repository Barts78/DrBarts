...
Vizlocation <- paste0("~/Dropbox/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Leoni")

#set Away
Away_Team <- paste0("Napoli")
...
#set transfer target
Transfer_Target <- paste("Koni De Winter")
