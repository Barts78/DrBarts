...
#Set LFC
Home_Team <- paste("Manchester United")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/bf6aa8ee/Manchester-United-Ipswich-Town-February-26-2025-Premier-League") #check
...
#set transfer target
Transfer_Target <- paste("Liam Delap")
```
