...
MatchIdFbref <- paste("https://fbref.com/en/matches/f274f9b1/Athletic-Club-Slavia-Prague-October-24-2024-Europa-League") #check
...
#set transfer target
Transfer_Target <- paste("El Hadji Diouf")
```
