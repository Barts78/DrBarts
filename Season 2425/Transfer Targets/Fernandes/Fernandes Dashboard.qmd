...
MatchIdFbref <- paste("https://fbref.com/en/matches/eac9b447/Arouca-Porto-March-1-2025-Primeira-Liga") #check
...
#set transfer target
Transfer_Target <- paste("Martim Fernandes")
```
