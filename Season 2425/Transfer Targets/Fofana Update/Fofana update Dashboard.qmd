...
Vizlocation <- paste0("~/Dropbox/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Fofana update")

#set Away
Away_Team <- paste0("Angers")
...
#set transfer target
Transfer_Target <- paste("Malick Fofana")
