...
#set Away color
Color_Away <- paste("blue3")

#set Away text
Color_Away_Text <- paste("white")

#Set Home
Home_Team <- paste0("Nice")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/29e9616d/Nice-Lyon-March-9-2025-Ligue-1") #check
