...
#set Away
Away_Team <- paste("Bayer Leverkusen")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/fb471c62/Stuttgart-Bayer-Leverkusen-March-16-2025-Bundesliga") #check
...
#set transfer target
Transfer_Target <- paste("Jeremie Frimpong")
```
