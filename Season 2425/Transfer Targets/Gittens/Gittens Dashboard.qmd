...
#Set Home
Home_Team <- paste0("Dortmund")

#set Home color
Color_Home <- paste("yellow2")

#set home text color
Color_Home_Text <- paste("black")

#set home color scale
ColorScale_Home <- paste("ggsci::yellow_material")

#set home color scale con
ColorScale_HomeC <- paste("ggthemes::Classic Orange")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/cf33e56f/Dortmund-Barcelona-December-11-2024-Champions-League") #check
...
#set transfer target
Transfer_Target <- paste("Jamie Gittens")
