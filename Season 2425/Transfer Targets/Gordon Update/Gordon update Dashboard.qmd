...
Vizlocation <- paste0("~/Dropbox/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Gordon update")

#set Away
Away_Team <- paste0("Chelsea")
...
#set transfer target
Transfer_Target <- paste("Anthony Gordon")
