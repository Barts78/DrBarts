...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Match day 20/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Match day 20/Viz Pack/")

#set oppo
Match_Oppo <- paste("Newcastle United")

#set oppo color
Color_Oppo <- paste("grey4")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/107b2d79/Liverpool-Newcastle-United-January-1-2024-Premier-League") #check

#set Game name
GameName <- paste("LFC_vs_NUFC")

GameWeek <- paste("MD20")

#set Game name PLayers
GameNamePlayers <- paste("LFC_vs_NUFC_players")
