...
Vizlocation <- paste0("~/Dropbox/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Gyokeres")

#set Away
Away_Team <- paste0("Vitoria de Guimaraes")
...
#set transfer target
Transfer_Target <- paste("Viktor Gyökeres")
