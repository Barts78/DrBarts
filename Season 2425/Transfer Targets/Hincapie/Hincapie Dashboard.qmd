...
#set oppo
Match_Oppo <- paste("Bayer Leverkusen")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/cb3e9794/Bayer-Leverkusen-Bayern-Munich-February-10-2024-Bundesliga") #check

#set Game name
GameName <- paste("BLFC_vs_BMFC")

GameWeek <- paste("BuLiMD21")

#set Game name PLayers
GameNamePlayers <- paste("BLFC_vs_BMFC_players")
...
Transfer_Target <- paste("Piero Hincapié")
```
