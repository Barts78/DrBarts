...
#set Away
Away_Team <- paste("Newcastle United")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/7d05223b/Southampton-Newcastle-United-January-25-2025-Premier-League") #check
...
GameNamePlayers <- paste("SFC_vs_NUFC_players")
