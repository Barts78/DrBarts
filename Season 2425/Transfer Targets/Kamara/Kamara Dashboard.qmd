...
#set Away
Away_Team <- paste0("Nottingham Forest")
...
#set home text color
Color_Home_Text <- paste("lightblue3")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/7b024699/Aston-Villa-Nottingham-Forest-April-5-2025-Premier-League") #check
...
#set transfer target
Transfer_Target <- paste("Boubacar Kamara")
