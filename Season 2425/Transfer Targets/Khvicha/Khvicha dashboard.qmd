...
ColorScale_AwayC <- paste("ggthemes::Blue Light")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/8a3f7f87/Internazionale-Napoli-November-10-2024-Serie-A") #check
...
#set transfer target
Transfer_Target <- paste("Khvicha Kvaratskhelia")
```
