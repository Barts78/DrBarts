...
MatchIdFbref <- paste("https://fbref.com/en/matches/cfcc6770/RB-Leipzig-Bayer-Leverkusen-January-25-2025-Bundesliga") #check
...
#set transfer target
Transfer_Target <- paste("Amadou Koné")
```
