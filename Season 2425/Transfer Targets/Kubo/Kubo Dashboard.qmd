...
#set oppo
Match_Oppo <- paste("Real Sociedad")
...
#Set LFC
Match_LFC <- paste("Real Madrid")

#set Home color
Color_LFC <- paste("grey4")
...
#set Game name
GameName <- paste("MFC_vs_RMFC")

GameWeek <- paste("MD23")

#set Game name PLayers
GameNamePlayers <- paste("MFC_vs_RMFC_players")
...
Transfer_Target <- paste("Takefusa Kubo")
```
