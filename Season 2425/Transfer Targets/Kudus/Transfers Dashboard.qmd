...
OppoPlottingData <- plottingData %>%
  filter(playerId == "Mohammed Kudus")
...
OppoPossession <- round((((sum(OppoPlottingData$Touches == 1 & OppoPlottingData$teamId == Match_Oppo))/Possession)*100),2)
HomeEPV <- round(sum(plottingData$EPVvalue[plottingData$teamId == Match_LFC & plottingData$`outcomeType/value` == 1]),2)
OppoEPV <- round(sum(OppoPlottingData$EPVvalue[OppoPlottingData$teamId == Match_Oppo & OppoPlottingData$`outcomeType/value` == 1]),2)
HomeEPVA <- round(sum(plottingData$TeamEPV[plottingData$teamId == Match_LFC & plottingData$`outcomeType/value` == 1]),2)
OppoEPVA <- round(sum(OppoPlottingData$TeamEPV[OppoPlottingData$teamId == Match_Oppo & OppoPlottingData$`outcomeType/value` == 1]),2)
HomexG <- round(sum(plottingData$xG[plottingData$teamId == Match_LFC]),2)
OppoxG <- round(sum(OppoPlottingData$xG[OppoPlottingData$teamId == Match_Oppo]),2)
HomeNPxG <- round(sum(plottingData$NPxG[plottingData$teamId == Match_LFC]),2)
OppoNPxG <- round(sum(OppoPlottingData$NPxG[OppoPlottingData$teamId == Match_Oppo]),2)
HomeBCs <- round(sum(plottingData$BCs[plottingData$teamId == Match_LFC]),0)
OppoBCs <- round(sum(OppoPlottingData$BCs[OppoPlottingData$teamId == Match_Oppo]),0)
...
OppoFieldTilt <- round((((sum(OppoPlottingData$Final_Third_Touches == 1 & OppoPlottingData$teamId == Match_Oppo))/Final_Third_Possession)*100),2)
...
OppopassPlot1stWD <- plot_passnet_AI(data = OppoPlottingData,  
...
```{r away 2nd half}
OppopassPlot2ndWD <- plot_passnet_AI(data = OppoPlottingData,  
                                   team_name = Match_Oppo, scale_stat = "EPV", 
...
``` {r away 1st subs}
OppopassPlot1stsubsWD <- plot_passnet_AI(data = OppoPlottingData, 
                                        team_name = Match_Oppo, scale_stat = "EPV", 
...
```{r away wrap}
OppopassPlotWrapWD <- plot_passnet_AI(data = OppoPlottingData,  
                                      team_name = Match_Oppo, scale_stat = "EPV", 
...
OppopassPlot1stAtt <- plot_passnet_AI(data = OppoPlottingData, 
                                     team_name = Match_Oppo, scale_stat = "EPV", 
                                     scale_color = Color_Oppo, text_color = Color_Oppo_Text, subtitle = paste0(Match_Fixture, " 1st Half"),
...
OppopassPlot2ndAtt <- plot_passnet_AI(data = OppoPlottingData,
                                     team_name = Match_Oppo, scale_stat = "EPV", 
                                     scale_color = Color_Oppo, text_color = Color_Oppo_Text, subtitle = paste0(Match_Fixture, " 2nd Half"),
...
OppopassPlot1SubAtt <- plot_passnet_AI(data = OppoPlottingData,
                                      team_name = Match_Oppo, scale_stat = "EPV", 
...
```{r}
OppopassPlotFTAttW <- plot_passnet_AI(data = OppoPlottingData,  
                                     team_name = Match_Oppo, scale_stat = "EPV", 
...
```{r oppo waves plot}
Oppotouchpass_bar_data <- OppoPlottingData 
...
Zone14_Passes_Oppo_Data <- OppoPlottingData %>%
  filter(teamId == Match_Oppo,
         Zone_14_Start == 1 | Zone_14_Finish == 1) %>%
  select(teamId, playerId, x, y, finalX, finalY, C_End_point_X, C_End_point_Y, Successful_Carries, UnSuccessful_Carries, Prog_Carries, Successful_Passes, UnSuccessful_Passes, Prog_Passes, Distance_Metre, Game_Period, EPVvalue, Zone_14_Finish, Zone_14_Start)
...
LHS_Passes_Oppo_Data <- OppoPlottingData %>%
  filter(teamId == Match_Oppo,
         Left_HS_Finish == 1 | Left_HS_Start == 1) %>%
  select(teamId, playerId, x, y, finalX, finalY, C_End_point_X, C_End_point_Y, Successful_Carries, UnSuccessful_Carries, Prog_Carries, Successful_Passes, UnSuccessful_Passes, Prog_Passes, Distance_Metre, Game_Period, EPVvalue, Left_HS_Finish, Left_HS_Start)
...
OppoEPVPlotData <- OppoPlottingData
...
#data wrangling
OppoEPVAreaPlotData <- OppoPlottingData
...
#  geom_smooth(size = 1.5, colour = Color_Oppo) +
  ...
  scale_x_continuous(breaks = seq(0, 145, 15)) +
  scale_y_continuous(limits = c(0, 3), breaks = seq(0, 3, 0.5)) +
  labs( title = paste0("Kudus Mohammed", " EPV Development"),
         subtitle = paste0(Match_Fixture),
         caption = My_caption,
         x = "Match time (Mins)",
         y = "EPV") +
...
#Oppo EPV heat plots
#| output: false
OppoEPVHeatMapData <- OppoPlottingData %>%
  filter(teamId == Match_Oppo) %>%
  filter(!`qualifiers/0/type/value` == 2, 
         !`qualifiers/0/type/value` == 6, #corner
         !`qualifiers/0/type/value` == 5, #free kick
...
OppoEPVHeatMapplotFT <- OppoEPVHeatMapDataFT %>%
  ...
  #formatting
  labs(title = paste("Kudus Mohammed"," Open Play EPV Heat Map - Full Game"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
OppoEPVHeatMapplot1sub <- OppoEPVHeatMapData1sub %>%
  ...
  #formatting
  labs(title = paste("Kudus Mohammed"," Open Play EPV Heat Map - Up to 1st Subs"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
OppoEPVHeatMapplotP1sub <- OppoEPVHeatMapDataP1sub %>%
  ...
  #formatting
  labs(title = paste("Kudus Mohammed"," Open Play EPV Heat Map - Post 1st Subs"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
OppoEPVHeatMapplot1H <- OppoEPVHeatMapData1H %>%
  ...
  #formatting
  labs(title = paste("Kudus Mohammed"," Open Play EPV Heat Map - First Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
OppoEPVHeatMapplot2H <- OppoEPVHeatMapData2H %>%
  ...
  #formatting
  labs(title = paste("Kudus Mohammed"," Open Play EPV Heat Map - Second Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
OppoEPVHeatMapplotFTW <- OppoEPVHeatMapDataFTW %>%
  ...
  #formatting
  labs(title = paste("Kudus Mohammed"," Open Play EPV Heat Map - By Game Period"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
#Load away data
Oppodashboard_data <- OppoPlottingData
...
```{r away bubble plot}
OppoShotBubblexG_data <- OppoPlottingData 
