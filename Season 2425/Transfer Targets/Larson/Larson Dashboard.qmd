...
#set Away
Away_Team <- paste("Eintracht Frankfurt")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/290c08bf/Ajax-Eintracht-Frankfurt-March-6-2025-Europa-League") #check
...
GameWeek <- paste("ULMD25")

#set transfer target
Transfer_Target <- paste("Hugo Larsson")
```
