...
Vizlocation <- paste0("~/Dropbox/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Lukeba update")

#set Away
Away_Team <- paste0("Bayern")
...
#set transfer target
Transfer_Target <- paste("Castello Lukeba")
...
AwayconvexPlot1stSubs <- TouchPlayerPlot_AI(TouchDataLFC,  title = Home_Team,
...
AwaytouchPlot1Sub <- TouchTeamPlot_OPTA(LFCTeamTouchData,  title = paste0(Home_Team, " Team On Ball Touch"),
