...
MatchIdFbref <- paste("https://fbref.com/en/matches/2155226b/Stuttgart-Eintracht-Frankfurt-November-10-2024-Bundesliga") #check
...
GameNamePlayers <- paste("SFC_vs_EFFC_players")

#set transfer target
Transfer_Target <- paste("Omar Marmoush")
```
