...
Vizlocation <- paste0("~/Dropbox/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Nusa")

#set Away
Away_Team <- paste0("Stuttgart")
...
#set transfer target
Transfer_Target <- paste("Antonio Nusa")
