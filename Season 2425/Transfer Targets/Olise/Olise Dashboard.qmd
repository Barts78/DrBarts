...
Vizlocation <- paste0("~/Dropbox/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Olise")
...
#set transfer target
Transfer_Target <- paste("Michael Olise")
