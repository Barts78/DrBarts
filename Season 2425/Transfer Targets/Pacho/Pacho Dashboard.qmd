...
#set oppo
Match_Oppo <- paste("Eintracht Frankfurt")

#set oppo color
Color_Oppo <- paste("black")

#set oppo text
Color_Oppo_Text <- paste("snow1")

#Set LFC
Match_LFC <- paste("Bayern München")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/251c1dd6/Eintracht-Frankfurt-Bayern-Munich-December-9-2023-Bundesliga") #check

#set Game name
GameName <- paste("EFFC_vs_BMFC")

GameWeek <- paste("BuLiMD14")

#set Game name PLayers
GameNamePlayers <- paste("EFFC_vs_BMFC_players")
...
Transfer_Target <- paste("Willian Pacho")
