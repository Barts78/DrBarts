...
MatchIdFbref <- paste("https://fbref.com/en/matches/33b426d2/Empoli-Torino-December-13-2024-Serie-A") #check
...
#set transfer target
Transfer_Target <- paste("Samuele Ricci")
```
