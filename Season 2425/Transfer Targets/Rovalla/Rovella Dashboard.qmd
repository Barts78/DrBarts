...
#Set Home
Home_Team <- paste0("Lazio")

#set Home color
Color_Home <- paste("lightblue3")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/6e84530a/Barcelona-Girona-March-30-2025-La-Liga") #check
...
#set transfer target
Transfer_Target <- paste("Nicolò Rovella")
