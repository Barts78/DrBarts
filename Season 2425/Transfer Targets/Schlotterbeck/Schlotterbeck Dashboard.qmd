...
MatchIdFbref <- paste("https://fbref.com/en/matches/e96a9875/St-Pauli-Dortmund-March-1-2025-Bundesliga") #check
...
#set transfer target
Transfer_Target <- paste("Nico Schlotterbeck")
```
