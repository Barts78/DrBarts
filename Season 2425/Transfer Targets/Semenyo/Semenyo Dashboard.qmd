...
#Set LFC
Home_Team <- paste("Manchester City")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/ed970fef/Bournemouth-Manchester-City-November-2-2024-Premier-League") #check
...
GameNamePlayers <- paste("BFC_vs_DAFC_players")

#set transfer target
Transfer_Target <- paste("Antoine Semenyo")
```
