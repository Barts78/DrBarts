...
#Set LFC
Home_Team <- paste("Holstein Kiel")

#set Home color
Color_Home <- paste("blue4")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/55cb7968/Holstein-Kiel-Stuttgart-March-8-2025-Bundesliga") #check
...
#set transfer target
Transfer_Target <- paste("Angelo Stiller")
```
