...
MatchIdFbref <- paste("https://fbref.com/en/matches/aa40c93b/Nurnberg-Eintracht-Braunschweig-December-21-2024-2-Bundesliga") #check
...
#set transfer target
Transfer_Target <- paste("Stefanos Tzimas")
