...
MatchIdFbref <- paste("https://fbref.com/en/matches/618988b7/Real-Madrid-Alaves-September-24-2024-La-Liga") #check
...
GameNamePlayers <- paste("RMFC_vs_DAFC_players")

#set transfer target
Transfer_Target <- paste("Aurélien Tchouaméni")
```
