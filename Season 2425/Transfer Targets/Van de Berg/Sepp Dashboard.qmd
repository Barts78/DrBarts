...
#set Away
Away_Team <- paste("Mainz 05")

#set Away color
Color_Away_Team <- paste("red")

#set Away text
Color_Away_Team_Text <- paste("white")

#Set LFC
Home_Team <- paste("Bayer Leverkusen")

#set Home color
Color_Home_Team <- paste("grey4")

#set home text color
Color_Home_Team_Text <- paste("white")
...
Away_Color = Color_Away_Team
Home_Color = Color_Home_Team

#set fixture
Match_Fixture <- paste0(Home_Team, " vs ", Away_Team, Game_date)

#set dashboard fixture
Match_Fixture_Dash <- paste0(Home_Team, " vs ", Away_Team, Game_date)

#set  UnderStat match ID
MatchIdUS <- 22088 #check

#Set Fotmob Match ID
MatchIdFotmob <- 4222026 #check

#set Fotmob LFC / home team ID
HomeIdFotmob <- 8178

#set Fotmob Away team ID
AwayIdFotmob <- 9905

#set fbref match page
MatchIdFbref <- paste("https://fbref.com/en/matches/f1ee2f4d/Bayer-Leverkusen-Mainz-05-February-23-2024-Bundesliga") #check

#set Game name
GameName <- paste("MFC_vs_BLFC")

GameWeek <- paste("MD23")

#set Game name PLayers
GameNamePlayers <- paste("MFC_vs_BLFC_players")
...
Transfer_Target <- paste("Sepp van den Berg")
```
...
WavesTitle_text <- paste0(
            glue("<span style='font-family:\"Arial Bold\";color:{Color_Home_Team};font-size:16px;'>{Home_Team}</span><span style='font-family:\"Arial\";color:gray12;font-size:16px;'> Attacking Waves </span><span style='color:gray12;font-size:16px;'>(</span><span style='font-family:\"Arial Bold\";color:{Color_Home_Team};font-size:16px;'>Touches</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:ivory4;font-size:16px;'>Passes</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:green3;font-size:16px;'>Shots</span><span style='color:gray12;font-size:16px;'>)</span>"))

AwayWavesTitle_text <- paste0(
            glue("<span style='font-family:\"Arial Bold\";color:{Color_Away_Team};font-size:16px;'>{Away_Team}</span><span style='font-family:\"Arial\";color:gray12;font-size:16px;'> Attacking Waves </span><span style='color:gray12;font-size:16px;'>(</span><span style='font-family:\"Arial Bold\";color:{Color_Away_Team};font-size:16px;'>Touches</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:ivory4;font-size:16px;'>Passes</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:green3;font-size:16px;'>Shots</span><span style='color:gray12;font-size:16px;'>)</span>"))

#set xg line titles 
xGlineTitle_text <- paste0(
          glue("<span style='font-family:\"Arial Bold\";color:{Color_Home_Team};font-size:16px;'>xG</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:{Color_Home_Team};font-size:16px;'>NPxG Dashed</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:ivory4;font-size:16px;'>xGOT</span><span style='color:gray12;font-size:16px;'> development</span>"))

AwayxGlineTitle_text <- paste0(
          glue("<span style='font-family:\"Arial Bold\";color:{Color_Away_Team};font-size:16px;'>xG</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:{Color_Away_Team};font-size:16px;'>NPxG Dashed</span><span style='color:gray12;font-size:16px;'>, </span><span style='font-family:\"Arial Bold\";color:ivory4;font-size:16px;'>xGOT</span><span style='color:gray12;font-size:16px;'> development</span>"))
...
HomePossession <- round((((sum(plottingData$Touches == 1 & plottingData$teamId == Home_Team))/Possession)*100),2)
AwayPossession <- round((((sum(plottingData$Touches == 1 & plottingData$teamId == Away_Team))/Possession)*100),2)
HomeEPV <- round(sum(plottingData$EPVvalue[plottingData$teamId == Home_Team & plottingData$`outcomeType/value` == 1]),2)
AwayEPV <- round(sum(plottingData$EPVvalue[plottingData$teamId == Away_Team & plottingData$`outcomeType/value` == 1]),2)
HomeEPVA <- round(sum(plottingData$TeamEPV[plottingData$teamId == Home_Team & plottingData$`outcomeType/value` == 1]),2)
AwayEPVA <- round(sum(plottingData$TeamEPV[plottingData$teamId == Away_Team & plottingData$`outcomeType/value` == 1]),2)
HomexG <- round(sum(plottingData$xG[plottingData$teamId == Home_Team]),2)
AwayxG <- round(sum(plottingData$xG[plottingData$teamId == Away_Team]),2)
HomeNPxG <- round(sum(plottingData$NPxG[plottingData$teamId == Home_Team]),2)
AwayNPxG <- round(sum(plottingData$NPxG[plottingData$teamId == Away_Team]),2)
HomeBCs <- round(sum(plottingData$BCs[plottingData$teamId == Home_Team]),0)
AwayBCs <- round(sum(plottingData$BCs[plottingData$teamId == Away_Team]),0)
Final_Third_Possession <- round(sum(plottingData$Final_Third_Touches),2)
HomeFieldTilt <- round((((sum(plottingData$Final_Third_Touches == 1 & plottingData$teamId == Home_Team))/Final_Third_Possession)*100),2)
AwayFieldTilt <- round((((sum(plottingData$Final_Third_Touches == 1 & plottingData$teamId == Away_Team))/Final_Third_Possession)*100),2)

# setup data frame from main variables above for summary tables
PossessionTable <- data.frame(
  teamId = c(Home_Team, Away_Team),
...
AwaypassPlot1stWD <- plot_passnet_AI(data = plottingData,  
                                   ...
                                   scale_color = Color_Away_Team,  text_color = Color_Away_Team_Text, subtitle = paste0(Match_Fixture, " 1st Half"),
...
AwaypassPlot2ndWD <- plot_passnet_AI(data = plottingData,  
                                   team_name = Away_Team, scale_stat = "EPV", 
                                   scale_color = Color_Away_Team, text_color = Color_Away_Team_Text,  subtitle = paste0(Match_Fixture, " 2nd Half"),
...
AwaypassPlot1stsubsWD <- plot_passnet_AI(data = plottingData, 
                                        team_name = Away_Team, scale_stat = "EPV", 
                                        scale_color = Color_Away_Team,  text_color = Color_Away_Team_Text, subtitle = paste0(Match_Fixture, " To 1st Subs"),
...
AwaypassPlotWrapWD <- plot_passnet_AI(data = plottingData,  
                                      team_name = Away_Team, scale_stat = "EPV", 
                                      scale_color = Color_Away_Team,  text_color = Color_Away_Team_Text, subtitle = paste0(Match_Fixture),
...
AwaypassPlot1SubAtt <- plot_passnet_AI(data = plottingData,
                                      team_name = Away_Team, scale_stat = "EPV", 
                                      scale_color = Color_Away_Team,  text_color = Color_Away_Team_Text, subtitle = paste0(Match_Fixture, " up to 1st Sub"),
...
AwaypassPlotFTAttW <- plot_passnet_AI(data = plottingData,  
                                     team_name = Away_Team, scale_stat = "EPV", 
                                     scale_color = Color_Away_Team,  text_color = Color_Away_Team_Text, subtitle = paste0(Match_Fixture, " By Time Period (Opta data)"),
...
Awaytouchpass_bar_plot <- Awaytouchpass_bar_data %>%
  ...
  #bars
  geom_bar(aes(x = expandedMinute, y = Touches, fill = Color_Away_Team), stat = "identity", colour = "black", width = 1, position = position_nudge(x = 0.5)) +
  ...
  scale_fill_identity(name = "",
                      breaks = c(Color_Away_Team,"ivory4", "green3"),
...
passing_sequencesTT_Plot <- passing_sequencesTT %>%
  ...
  theme(plot.title = element_text(colour = "black", face = "bold", size = 14),
        ...
        panel.background = element_blank(),
        legend.position = "none",
        strip.text = element_text(size = 6, colour = Color_Away_Team_Text),
        strip.background = element_rect(fill = Color_Away_Team, color = "black", linetype = "solid", linewidth = 1))
...
Home_Passing_Chains_Table <- passing_sequencesTT_Table %>%
  ...
  tab_options(
    ...
    heading.align = "left",
    column_labels.background.color = Color_Away_Team,
    row_group.background.color = Color_Away_Team,
...
#  cols_width(Player ~ px(45)) %>% # 110 = 100 (height) + 10 (padding around imgs)
  ...
  fmt_number(
    ...
    decimals = 2) %>%
  tab_style(
    style = list(cell_text(weight = "bold", color = Color_Away_Team_Text), cell_fill(color = Color_Away_Team)),
...
AwayconvexPlot1stSubs <- TouchPlayerPlot_AI(TouchDataAway,  title = Away_Team,
                                     plot_start = 00, plot_finish = firstSubAway,  color = Color_Away_Team, text_color = Color_Away_Team_Text,
...
LFCDribblesPlotP <- LFCDribblesmapdata %>%
  ...
  theme(plot.title = element_markdown(),
        ...
        plot.subtitle = element_text(colour = "black", size = 10),
        legend.position = "none",
        strip.text.x = element_text(face = "bold", size = 8, colour = Color_Home_Team_Text),
        strip.background.x = element_rect(fill = Color_Home_Team, color = "black", linetype = "solid", linewidth = 1))
LFCDribblesPlotP
...
AwayDulesPlotP <- AwayDuelsmapdata %>%
  ...
  theme(plot.title = element_markdown(),
        ...
        plot.subtitle = element_text(colour = "black", size = 10),
        legend.position = "none",
        strip.text.x = element_text(face = "bold", size = 8, colour = Color_Away_Team_Text),
        strip.background.x = element_rect(fill = Color_Away_Team, color = "black", linetype = "solid", linewidth = 1))
AwayDulesPlotP
...
Player_Summary_Plot_Home <- Player_Summary_data_Home %>% 
  ...
  theme(plot.subtitle = element_text(colour = "black", size = 8),
        ...
        panel.background = element_rect(colour = "snow", fill = "snow"),
        plot.background = element_rect(fill = "snow", color = "snow"),
        strip.text.x = element_text(size = 4, colour = Color_Away_Team_Text, face = "bold"),
        strip.background.x = element_rect(fill = Color_Away_Team, color = "black", linetype = "solid", linewidth = 0.5),
...
#AwayEPVTimePlot_I <- ggplotly(AwayEPVTimePlot, tooltip = "text")
#AwayEPVTimePlot_I
...
EPVMapplotFT <- ggplot(average_epvFT, aes(x = zone_x, y = zone_y, fill = avg_epv)) +
  ...
  #formatting
  labs(title = paste0(Home_Team," Open Play EPV Heat Map - Full Game"), 
...
EPVHeatMapplotFT <- EPVHeatMapDataFT %>%
  ...
  #plot player positions
  geom_point(data = AwayAverage_PlayerFT, aes(x, y), fill = Color_Away_Team, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = AwayAverage_PlayerFT, aes(x, y, label = player_shirt), color = Color_Away_Team_Text, size = 2) +
...
AwayEPVHeatMapplotFT <- AwayEPVHeatMapDataFT %>%
  ...
  #plot player positions
  geom_point(data = Average_PlayerFT, aes(x, y), fill = Color_Home_Team, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = Average_PlayerFT, aes(x, y, label = player_shirt), color = Color_Home_Team_Text, size = 2) +
  
  scale_fill_paletteer_d(ColorScale_Away) +
  scale_color_paletteer_d(ColorScale_Away) +
  
  #formatting
  labs(title = paste(Away_Team," Open Play EPV Heat Map - Full Game"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
EPVHeatMapplot1sub <- EPVHeatMapData1sub %>%
  ...
  #plot player positions
  geom_point(data = AwayAverage_Player1Sub, aes(x, y), fill = Color_Away_Team, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = AwayAverage_Player1Sub, aes(x, y, label = player_shirt), color = Color_Away_Team_Text, size = 2) +
    
   scale_fill_paletteer_d(ColorScale_Home) +
   scale_color_paletteer_d(ColorScale_Home) +
  
  #formatting
  labs(title = paste0(Home_Team," Open Play EPV Heat Map - Up to first subs"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
EPVHeatMapplotP1sub <- EPVHeatMapDataP1sub %>%
  ...
  #plot player positions
  geom_point(data = AwayAverage_PlayerP1Sub, aes(x, y), fill = Color_Away_Team, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = AwayAverage_PlayerP1Sub, aes(x, y, label = player_shirt), color = Color_Away_Team_Text, size = 2) +
    
   scale_fill_paletteer_d(ColorScale_Home) +
   scale_color_paletteer_d(ColorScale_Home) +
  
  #formatting
  labs(title = paste0(Home_Team," Open Play EPV Heat Map - Post 1st Subs"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayEPVHeatMapplot1sub <- AwayEPVHeatMapData1sub %>%
  ...
  #plot player positions
  geom_point(data = Average_Player1Sub, aes(x, y), fill = Color_Home_Team, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = Average_Player1Sub, aes(x, y, label = player_shirt), color = Color_Home_Team_Text, size = 2) +
  
  scale_fill_paletteer_d(ColorScale_Away) +
  scale_color_paletteer_d(ColorScale_Away) +
  
  #formatting
  labs(title = paste(Away_Team," Open Play EPV Heat Map - Up to 1st Subs"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayEPVHeatMapplotP1sub <- AwayEPVHeatMapDataP1sub %>%
  ...
  #plot player positions
  geom_point(data = Average_PlayerP1Sub, aes(x, y), fill = Color_Home_Team, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = Average_PlayerP1Sub, aes(x, y, label = player_shirt), color = Color_Home_Team_Text, size = 2) +
  
  scale_fill_paletteer_d(ColorScale_Away) +
  scale_color_paletteer_d(ColorScale_Away) +
  
  #formatting
  labs(title = paste(Away_Team," Open Play EPV Heat Map - Post 1st Subs"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
EPVHeatMapplot1H <- EPVHeatMapData1H %>%
  ...
  #plot player positions
  geom_point(data = AwayAverage_Player1H, aes(x, y), fill = Color_Away_Team, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = AwayAverage_Player1H, aes(x, y, label = player_shirt), color = Color_Away_Team_Text, size = 2) +
    
   scale_fill_paletteer_d(ColorScale_Home) +
   scale_color_paletteer_d(ColorScale_Home) + 
  
  #formatting
  labs(title = paste0(Home_Team," Open Play EPV Heat Map - First Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
EPVHeatMapplot2H <- EPVHeatMapData2H %>%
  ...
  #plot player positions
  geom_point(data = AwayAverage_Player2H, aes(x, y), fill = Color_Away_Team, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = AwayAverage_Player2H, aes(x, y, label = player_shirt), color = Color_Away_Team_Text, size = 2) +
    
   scale_fill_paletteer_d(ColorScale_Home) +
   scale_color_paletteer_d(ColorScale_Home) +
  
  #formatting
  labs(title = paste0(Home_Team," Open Play EPV Heat Map - Second Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayEPVHeatMapplot1H <- AwayEPVHeatMapData1H %>%
  ...
  #plot player positions
  geom_point(data = Average_Player1H, aes(x, y), fill = Color_Home_Team, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = Average_Player1H, aes(x, y, label = player_shirt), color = Color_Home_Team_Text, size = 2) +
  
  scale_fill_paletteer_d(ColorScale_Away) +
  scale_color_paletteer_d(ColorScale_Away) +
  
  #formatting
  labs(title = paste(Away_Team," Open Play EPV Heat Map - First Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
AwayEPVHeatMapplot2H <- AwayEPVHeatMapData2H %>%
  ...
  #plot player positions
  geom_point(data = Average_Player2H, aes(x, y), fill = Color_Home_Team, size = 5, shape = 21, colour = "black", stroke = 0.5) +
      
  #plot player names
  geom_text(data = Average_Player2H, aes(x, y, label = player_shirt), color = Color_Home_Team_Text, size = 2) +
  
  scale_fill_paletteer_d(ColorScale_Away) +
  scale_color_paletteer_d(ColorScale_Away) +
  
  #formatting
  labs(title = paste(Away_Team," Open Play EPV Heat Map - Second Half"), 
       subtitle = paste0(Match_Fixture,"  \nIncreased Colour = Higher, EPV, Box figures = % of Total EPV"),
       caption =  My_caption) +
  theme(plot.background = element_rect(colour = "snow", fill = "snow"),
        plot.caption = element_markdown(),
...
#  pivot_longer(cols = c(TotalxG, TotalNPxG, TotalxGOT), names_to = "Metric", values_to = "Value")
  ...
  #scale_color_manual(values = c("TotalxG" = Color_Home_Team, "TotalNPxG" = Color_Home_Team, "TotalxGOT" = "ivory4"), guide = guide_legend()) +
  
  #Geometrics
  #xg line
  geom_line(aes(x = expandedMinute, y = TotalxG), linewidth = 2, colour = Color_Away_Team) +
  
  #npXg line
  geom_line(aes(x = expandedMinute, y = TotalNPxG), linewidth = 1, colour = Color_Away_Team, linetype = "dashed") +
...
xGSituationBar <- xGSituationBarData %>%
  ...
  #Geometrics
  geom_bar(stat = "identity", fill = Color_Away_Team, colour = "#454545") +
...
#|height: 110%
#shot map
LFC_S_plot <- plot_shot_AI(dashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = "", mapName = Transfer_Target, teamColor = Color_Away_Team, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", logo = "", wrap = "")
...
```{r away shot plot}
#|height: 110%
Away_S_plot <- plot_shot_AI(Awaydashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = AwayHA,  mapName = Away_Team, teamColor = Color_Away_Team, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta")
...
#|height: 110%
LFC_S_plotW <- plot_shot_AI(dashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = "", mapName = Transfer_Target, teamColor = Color_Away_Team, text_color = Color_Away_Team_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", logo = "", wrap = "Player")
...
#|height: 110%
Away_S_plotW <- plot_shot_AI(Awaydashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = AwayHA,  mapName = Away_Team, teamColor = Color_Away_Team, text_color = Color_Away_Team_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", wrap = "Player")
...
#|height: 110%
LFC_S_plotWT <- plot_shot_AI(dashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = "", mapName = Transfer_Target, teamColor = Color_Away_Team, text_color = Color_Away_Team_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", logo = "", wrap = "Time")
...
#|height: 110%
Away_S_plotWT <- plot_shot_AI(Awaydashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = AwayHA,  mapName = Away_Team, teamColor = Color_Away_Team, text_color = Color_Away_Team_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", wrap = "Time")
