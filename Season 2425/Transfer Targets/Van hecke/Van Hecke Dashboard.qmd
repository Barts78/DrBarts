...
Vizlocation <- paste0("~/Dropbox/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Van hecke")

#set Away
Away_Team <- paste0("Liverpool")
...
#set transfer target
Transfer_Target <- paste("Jan Paul van Hecke")
...
ggsave(path = Vizlocation, "Player Ball Touch Zones 1st Sub.png", width = 2500, height = 2150, units = "px", dpi = 400)
...
AwaytouchPlot1Sub <- TouchTeamPlot_OPTA(AwayPPDAHeatMapData,  title = paste0(Transfer_Target, " Team Off Ball Touch"),
                                     plot_start = 00, plot_finish = firstSubHome, logo = "",
                                     subtitle = paste0(Match_Fixture, " Up to 1st Sub"))
AwaytouchPlot1Sub
