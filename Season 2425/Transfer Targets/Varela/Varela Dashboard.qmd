...
MatchIdFbref <- paste("https://fbref.com/en/matches/2ad57214/Porto-Arsenal-February-21-2024-Champions-League") #check

#set Game name
GameName <- paste("FCP_vs_AFC_UCLR16L1")

GameWeek <- paste("UCLR16L1")

#set Game name PLayers
GameNamePlayers <- paste("FCP_vs_AFC_UCLR16L1_players")
...
Transfer_Target <- paste("Alan Varela")
