...
#set away
Away_Team <- paste0("Viktoria Plzen")
...
#Set Home
Home_Team <- paste0("Athletic Club")

#set Home color
Color_Home <- paste("#d3171e")

#set home text color
Color_Home_Text <- paste("blue4")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/50752d2d/Athletic-Club-Viktoria-Plzen-January-30-2025-Europa-League") #check
...
#set transfer target
Transfer_Target <- paste("Nico Williams")
