...
#Set LFC
Match_LFC <- paste("Paris Saint-Germain")

#set Home color
Color_LFC <- paste("#004ca6")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/204a77b5/Lille-Paris-Saint-Germain-December-17-2023-Ligue-1") #check

#set Game name
GameName <- paste("LOSC_vs_PSGFC_Ligue1")

GameWeek <- paste("Ligue1")

#set Game name PLayers
GameNamePlayers <- paste("LOSC_vs_PSGFC_Ligue1_players")
...
Transfer_Target <- paste("Leny Yoro")
