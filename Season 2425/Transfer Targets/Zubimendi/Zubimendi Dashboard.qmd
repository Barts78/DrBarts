...
#set Away
Away_Team <- paste("Real Sociedad")

#set Away color
Color_Away_Team <- paste("dodgerblue4")

#set Away text
Color_Away_Team_Text <- paste("white")

#Set LFC
Home_Team <- paste("Real Madrid")

#set Home color
Color_Home_Team <- paste("white")

#set home text color
Color_Home_Team_Text <- paste("grey4")
...
Away_Color = Color_Home_Team
Home_Color = Color_Away_Team
...
MatchIdFbref <- paste("https://fbref.com/en/matches/3edf4d41/Real-Sociedad-Real-Madrid-April-26-2024-La-Liga") #check

#set Game name
GameName <- paste("RSFC_vs_RMFC")

GameWeek <- paste("MD33")

#set Game name PLayers
GameNamePlayers <- paste("RSFC_vs_RMFC_players")
...
Transfer_Target <- paste("Martín Zubimendi")
```
