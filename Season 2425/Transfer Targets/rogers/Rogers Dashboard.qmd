...
Vizlocation <- paste0("~/Dropbox/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Rogers")

#set Away
Away_Team <- paste0("Newcastle")
...
#set transfer target
Transfer_Target <- paste("Morgan Rogers")
