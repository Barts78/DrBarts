...
#set away
Match_Away <- paste0("Borussia M.Gladbach")

#Set Home
Match_Home <- paste0("Borussia Dortmund")

#set match date
Game_date <- paste("19-12-2025")
...
Vizlocation <- paste0("~/Documents/Dropbox files/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Adeyimi")
...
#set transfer target
Transfer_Target <- paste("Karim Adeyemi")
