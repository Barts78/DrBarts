...
Vizlocation <- paste0("~/Documents/Dropbox files/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Bastoni")

#set Away
Away_Team <- paste0("Lazio")

#set Away color
Color_Away <- paste("yellow2")

#set Away text
Color_Away_Text <- paste("blue")

#Set Home
Home_Team <- paste0("Inter")
...
ColorScale_AwayC <- paste("ggthemes::Yellow")

#set match date
Game_date <- paste("09-11-2025")
...
#set transfer target
Transfer_Target <- paste("Alessandro Bastoni")
