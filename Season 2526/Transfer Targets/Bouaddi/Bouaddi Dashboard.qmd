...
Vizlocation <- paste0("~/Documents/Dropbox files/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Bouaddi")

#set Away
Away_Team <- paste0("Metz")
...
#set transfer target
Transfer_Target <- paste("Ayyoub Bouaddi")
