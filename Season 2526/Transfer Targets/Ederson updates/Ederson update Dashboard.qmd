---
title: "Ederson Update Dashboard 2526"
...
Vizlocation <- paste0("~/Documents/Dropbox files/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Ederson updates")

#set Away
Away_Team <- paste0("Cagliari")
...
EPVHeatMapplotFT <- EPVHeatMapDataFT %>%
  ...
  #plot player names
  geom_text(data = Average_PlayerFT, aes(x, y, label = playerId), color = Color_Home_Text, size = 4) +
...
EPVHeatMapplot1H <- EPVHeatMapData1H %>%
  ...
  #plot player names
  geom_text(data = Average_Player1H, aes(x, y, label = playerId), color = Color_Home_Text, size = 4) +
...
EPVHeatMapplot2H <- EPVHeatMapData2H %>%
  ...
  #plot player names
  geom_text(data = AwayAverage_Player2H, aes(x, y, label = playerId), color = Color_Home_Text, size = 4) +
