---
title: "Guehi Update Dashboard 2526"
...
Vizlocation <- paste0("~/Documents/Dropbox files/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Guehi update 2526")

#set Away
Away_Team <- paste0("Liverpool")

#set Away color
Color_Away <- paste("green3")

#set Away text
Color_Away_Text <- paste("white")

#Set Home
Home_Team <- paste0("Crystal Palace")

#set Home color
Color_Home <- paste("red")

#set home text color
Color_Home_Text <- paste("blue")
...
#set transfer target
Transfer_Target <- paste("Marc Guéhi")
