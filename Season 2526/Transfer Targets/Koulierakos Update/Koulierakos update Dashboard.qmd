---
title: "Koulierakis Update Dashboard"
...
Vizlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Transfers/Koulierakos Update")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI lfc data/UP Pod Prep 2324/Transfers/Viz Pack/")

#set Away
Away_Team <- paste("Wolfsburg")
...
#Set LFC
Home_Team <- paste("Werder Bremen")

#set Home color
Color_Home <- paste("green")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/445a72d7/Werder-Bremen-Wolfsburg-March-1-2025-Bundesliga") #check
...
#set transfer target
Transfer_Target <- paste("Konstantinos Koulierakis")
...
AwayconvexPlot1stSubs <- TouchPlayerPlot_AI(TouchDataTTarget,  title = Home_Team,
...
AwaytouchPlot1Sub <- TouchTeamPlot_OPTA(TTTeamTouchData,  title = paste0(Home_Team, " Team On Ball Touch"),
