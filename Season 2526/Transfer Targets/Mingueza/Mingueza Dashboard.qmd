...
Vizlocation <- paste0("~/Documents/Dropbox files/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Mingueza")

#set Away
Away_Team <- paste0("Athletic club")
...
#set transfer target
Transfer_Target <- paste("Óscar Mingueza")
