...
Vizlocation <- paste0("~/Documents/Dropbox files/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Minteh update")

#set Away
Away_Team <- paste0("Tottenham")
