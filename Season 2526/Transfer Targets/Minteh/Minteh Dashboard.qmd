...
Vizlocation <- paste0("~/Dropbox/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Minteh")
...
#set transfer target
Transfer_Target <- paste("Yankuba Minteh")
