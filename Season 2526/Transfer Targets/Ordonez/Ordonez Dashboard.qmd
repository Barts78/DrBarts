...
Vizlocation <- paste0("~/Documents/Dropbox files/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Ordonez")


#set Away
Away_Team <- paste0("FCV Dender EH")
...
#set transfer target
Transfer_Target <- paste("Joel Ordóñez")
