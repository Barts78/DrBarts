---
title: "Semenyo Update Dashboard"
...
Vizlocation <- paste0("~/Documents/Dropbox files/AI lfc data/R files/AI UP/Scripts/Viz Pack/Season 2324/Transfers/Semenyo update")
...
EPVHeatMapplotFT <- EPVHeatMapDataFT %>%
  ...
  #geometrics
    #plot player positions
  geom_point(data = Average_PlayerFT, aes(x, y), fill = Color_Away, size = 8, shape = 21, colour = "black", stroke = 0.5, alpha = 0.4) +
  ...
  #plot player names
  geom_text(data = Average_PlayerFT, aes(x, y, label = playerId), color = Color_Away_Text, size = 4) +
...
EPVHeatMapplot1H <- EPVHeatMapData1H %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = Average_Player1H, aes(x, y), fill = Color_Away, size = 8, shape = 21, colour = "black", stroke = 0.5, alpha = 0.4) +
  ...
  #plot player names
  geom_text(data = Average_Player1H, aes(x, y, label = playerId), color = Color_Away_Text, size = 4) +
...
EPVHeatMapplot2H <- EPVHeatMapData2H %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = Average_Player2H, aes(x, y), fill = Color_Away, size = 8, shape = 21, colour = "black", stroke = 0.5, alpha = 0.4) +
  ...
  #plot player names
  geom_text(data = Average_Player2H, aes(x, y, label = playerId), color = Color_Away_Text, size = 4) +
